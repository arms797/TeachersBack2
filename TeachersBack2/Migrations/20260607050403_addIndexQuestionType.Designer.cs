...
namespace TeachersBack2.Migrations
{
    ...
    [Migration("20260607050403_addIndexQuestionType")]
    partial class addIndexQuestionType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeachersBack2.Models.Exam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("PracticalUnit")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("QuestionDesigner")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("QuestionDesignerCode")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<string>("TeachersCenter")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("TeachersCenterCode")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasIndex("DayOfWeek")
                        .HasDatabaseName("IX_Exams_DayOfWeek");
                    ...
                    b.HasIndex("QuestionType")
                        .HasDatabaseName("IX_Exams_QuestionType");

                    b.HasIndex("SourceNo")
                        .HasDatabaseName("IX_Exams_SourceNo");

                    b.HasIndex("Teacher")
                        .HasDatabaseName("IX_Exams_Teacher");

                    b.HasIndex("TeacherCode")
                        .HasDatabaseName("IX_Exams_TeacherCode");
            ...
            modelBuilder.Entity("TeachersBack2.Models.ScheduleLock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
